...
decomposition (mean F1 across five seeds: $0.879 \pm 0.056$,
...
Seed~1 is the only seed whose Q15 F1 (0.663) falls below the MLP
baseline (0.847); the remaining four seeds all exceed 0.89,
comfortably surpassing the MLP on every compression stage.
...
100\% via the \msp{} C engine, Table~\ref{tab:hstate}).
