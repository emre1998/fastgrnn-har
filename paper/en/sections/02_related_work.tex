...
\footnote{Based on searches of arXiv, GitHub, and Google Scholar
conducted in June~2026. We found no prior work providing both
a trained gated-RNN model \emph{and} a complete bare-metal
C deployment on a multiplier-less MCU with public code and
measured accuracy.}
