...
getirir. Ortaya çıkan modelin ağırlıkları yalnızca \textbf{566~bayt} yer
kaplar ve \hapt{} test kümesinde \textbf{makro F1 $=$ 0.918}
(0.~tohum; beş tohumda Q15 ortalaması $0.853{\pm}0.107$) değerine
ulaşır. Model, 3{,}399 test penceresinin tamamında PyTorch
referansıyla \textbf{\%100 tahmin uyumu} gösterir (MCU 0.~tohum;
beş tohumda C-eşdeğer \%99.91--100). Her iki platform da \textbf{50~Hz'de gerçek
...
(ii)~uçtan uca yanıt süresini belirleyen yinelemeli ısınma
gecikmesinin nicel incelenmesi (ortanca 74 örnek, 1.48~s;
en kötü durum 125 örnek, 2.50~s; 100 test penceresi);
