...
referansıyla tahmin düzeyinde \%100 uyuşur (0.~tohum; beş
tohumda \%99.91--100). Donanımdan bağımsız bu
...
\item \textbf{Yinelemeli ısınma gecikmesinin ölçülmesi.} 100 rastgele
test penceresi üzerinde, tahminlerin kararlı hâle gelmesi için gereken
adım sayısını ölçüyoruz: \textbf{ortanca 74 örnek (1.48~s)}, en kötü
durum 125 örnek (2.50~s, 50~Hz). Bu davranış donanımdan değil,
yinelemeli dinamiklerden kaynaklanır ve \fastgrnn{} sınıfı HAR
sistemlerinde kullanıcıya
