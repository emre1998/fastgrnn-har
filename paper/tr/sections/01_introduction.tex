...
makalenin ötesinde üç katkı öne çıkmaktadır:
...
\textbf{30.5$\times$} hızlandırır (54~s $\rightarrow$ 1.8~s).
Böylece gerçek zamanlı çalışamayan bir uygulama, 50~Hz akış
bütçesini rahatlıkla karşılayan bir hedefe dönüşür. Bu yöntem
...
doğruluk, bellek ayak izi ve gerçek zamanlı akış performansını
raporlar. Bölüm~\ref{sec:discussion}, ısınma gecikmesini ve
